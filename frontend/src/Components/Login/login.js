...
const Login = (props) => {
    ...
    return (
        <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }} className='p-10 w-full max-w-sm mx-auto'>
            ...
            <div className='space-y-4'>
                <div className='space-y-1'>
                    <label className='text-[10px] text-titan-muted font-black uppercase tracking-widest ml-1'>User ID / Email</label>
                    <input 
                        type='text' 
                        ...
                        placeholder='TITAN_99 or user@example.com' 
                    />
                </div>
